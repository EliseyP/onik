...
unicode_to_ucs_fonttable = {
    # unmatched CAPS
    unicCapitalUkrIe: UCS.CAPS.E,
    unicCapitalYat: UCS.CAPS.YAT,
    unicCapitalUkrI: UCS.CAPS.I_DECIMAL,
    unicCapitalRoundOmega: UCS.CAPS.O_BROAD,
    unicCapitalOt: UCS.CAPS.OT,
    unicCapitalUk: UCS.CAPS.OUK,
    unicCapitalMonogrUk: UCS.CAPS.OUK_MONOGR,
    unicCapitalMonogrUk_ALTER: UCS.CAPS.OUK_MONOGR,
    unicCapitalOmegaTitled: UCS.CAPS.O_GREAT,
    unicCapitalIotifA: UCS.CAPS.YA_IOTIF,
    unicCapitalLittleYus: UCS.CAPS.YA,
    unicCapitalIzhitsa: UCS.CAPS.IZHICA,
    unicCapitalOmega: UCS.CAPS.OMEGA,
    unicCapitalPsi: UCS.CAPS.PSI,
    unicCapitalKsi: UCS.CAPS.KSI,

    # unmatched SMALL
    unicSmallIzhitsa: UCS.SMALL.IZHICA,
    unicSmallYat: UCS.SMALL.YAT,
    unicSmallUkrI: UCS.SMALL.I_DECIMAL,
    unicSmallRoundOmega: UCS.SMALL.O_BROAD,
    unicSmallOmega: UCS.SMALL.OMEGA,
    unicSmallOmegaTitled: UCS.SMALL.O_GREAT,
    unicSmallOt: UCS.SMALL.OT,
    unicSmallMonogrUk: UCS.SMALL.OUK_MONOGR,
    unicSmallUk: UCS.SMALL.OUK,
    unicSmallFita: UCS.SMALL.FITA,
    unicSmallLittleYus: UCS.SMALL.YA,
    unicSmallIotifA: UCS.SMALL.YA_IOTIF,
    unicSmallPsi: UCS.SMALL.PSI,
    unicSmallKsi: UCS.SMALL.KSI,
    ...
    # Монографы.
    unicCapitalA + Zvatelce: UCS.CAPS.A_AND_ZVATELCO,
    unicCapitalA + Iso: UCS.CAPS.A_AND_ISO,
    unicCapitalIzhitsa + Kendema: UCS.CAPS.IZHICA_AND_KENDEMA,
    unicCapitalYi:  UCS.CAPS.I_DECIMAL_AND_DOTS,
    # Разбитый монограф unicCapitalYi на I c кендемой
    unicCapitalUkrI + Kendema:  UCS.CAPS.I_DECIMAL_AND_DOTS,
    unicCapitalUkrI + Zvatelce: UCS.CAPS.I_DECIMAL_AND_ZVATELCO,
    unicCapitalUkrI + Iso: UCS.CAPS.I_DECIMAL_AND_ISO,
    unicCapitalRoundOmega + Zvatelce: UCS.CAPS.O_BROAD_AND_ZVATELCO,
    unicCapitalRoundOmega + Iso: UCS.CAPS.O_BROAD_AND_ISO,
    unicCapitalOmega + Zvatelce: UCS.CAPS.OMEGA_AND_ZVATELCO,
    unicCapitalUk + Iso: UCS.CAPS.OUK_AND_ISO,
    unicCapitalUk + Zvatelce: UCS.CAPS.OUK_AND_ZVATELCO,
    unicCapitalLittleYus + Zvatelce: UCS.CAPS.YA_AND_ZVATELCO,
    unicCapitalIotifA + Zvatelce: UCS.CAPS.YA_IOTIF_AND_ZVATELCO,
    unicCapitalIotifA + Iso: UCS.CAPS.YA_IOTIF_AND_ISO,

    unicSmallA + Zvatelce: UCS.SMALL.A_AND_ZVATELCO,
    unicSmallA + Oxia: UCS.SMALL.A_AND_OXIA,
    unicSmallA + Varia: UCS.SMALL.A_AND_VARIA,
    unicSmallA + Kamora: UCS.SMALL.A_AND_KAMORA,
    unicSmallA + Iso: UCS.SMALL.A_AND_ISO,
    unicSmallA + Titlo: UCS.SMALL.A_AND_TITLO,
    unicSmallG + Titlo: UCS.SMALL.G_AND_TITLO,
    unicSmallD + titlo_s: UCS.SMALL.D_AND_TITLO_S,
    unicSmallIe + Oxia: UCS.SMALL.E_AND_OXIA,
    unicSmallIe + Varia: UCS.SMALL.E_AND_VARIA,
    unicSmallYat + Oxia: UCS.SMALL.YAT_AND_OXIA,
    unicSmallYat + Varia: UCS.SMALL.YAT_AND_VARIA,
    unicSmallYat + Kamora: UCS.SMALL.YAT_AND_KAMORA,
    unicSmallZh + Titlo: UCS.SMALL.ZH_AND_TITLO,
    unicSmallI + Titlo: UCS.SMALL.IZHE_AND_TITLO,
    # NOTE: есть монограф 457 а есть 456+dots
    unicSmallUkrI + Kendema: UCS.SMALL.I_DECIMAL_AND_DOTS,
    unicSmallUkrI + Zvatelce: UCS.SMALL.I_DECIMAL_AND_ZVATELCO,
    unicSmallUkrI + Oxia: UCS.SMALL.I_DECIMAL_AND_OXIA,
    unicSmallUkrI + Varia: UCS.SMALL.I_DECIMAL_AND_VARIA,
    unicSmallUkrI + Kamora: UCS.SMALL.I_DECIMAL_AND_KAMORA,
    unicSmallUkrI + Iso: UCS.SMALL.I_DECIMAL_AND_ISO,
    unicSmallUkrI + Titlo: UCS.SMALL.I_DECIMAL_AND_TITLO,
    unicSmallIzhitsa + Oxia: UCS.SMALL.IZHICA_AND_OXIA,
    unicSmallIzhitsa + Kamora: UCS.SMALL.IZHICA_AND_KAMORA,
    unicSmallIzhitsa + Kendema: UCS.SMALL.IZHICA_AND_KENDEMA,
    unicSmallIzhitsa + titlo_g: UCS.SMALL.IZHICA_AND_TITLO_G,
    unicSmallEl + Titlo: UCS.SMALL.L_AND_TITLO,
    unicSmallEl + titlo_d: UCS.SMALL.L_AND_TITLO_D,
    unicSmallO + Oxia: UCS.SMALL.O_AND_OXIA,
    unicSmallRoundOmega + Zvatelce: UCS.SMALL.O_BROAD_AND_ZVATELCO,
    unicSmallRoundOmega + Iso: UCS.SMALL.O_BROAD_AND_ISO,
    unicSmallOmega + Zvatelce: UCS.SMALL.OMEGA_AND_ZVATELCO,
    unicSmallEr + Titlo: UCS.SMALL.R_AND_TITLO,
    unicSmallEr + titlo_d: UCS.SMALL.R_AND_TITLO_D,
    unicSmallEr + titlo_s: UCS.SMALL.R_AND_TITLO_S,
    unicSmallEs + Titlo: UCS.SMALL.S_AND_TITLO,
    unicSmallTe + Titlo: UCS.SMALL.T_AND_TITLO,
    unicSmallMonogrUk + Oxia: UCS.SMALL.OUK_MONOGR_AND_OXIA,
    unicSmallMonogrUk + Varia: UCS.SMALL.OUK_MONOGR_AND_VARIA,
    unicSmallMonogrUk + Kamora: UCS.SMALL.OUK_MONOGR_AND_KAMORA,
    unicSmallUk + Zvatelce: UCS.SMALL.OUK_AND_ZVATELCO,
    unicSmallUk + Iso: UCS.SMALL.OUK_AND_ISO,
    unicSmallHa + Titlo: UCS.SMALL.HER_AND_TITLO,
    unicSmallChe + Titlo: UCS.SMALL.CH_AND_TITLO,
    unicSmallLittleYus + Zvatelce: UCS.SMALL.YA_AND_ZVATELCO,
    unicSmallLittleYus + Oxia: UCS.SMALL.YA_AND_OXIA,
    unicSmallLittleYus + Varia: UCS.SMALL.YA_AND_VARIA,
    unicSmallLittleYus + Kamora: UCS.SMALL.YA_AND_KAMORA,
    unicSmallLittleYus + Apostrof: UCS.SMALL.YA_AND_APOSTROF,
    unicSmallIotifA + Zvatelce: UCS.SMALL.YA_IOTIF_AND_ZVATELCO,
    unicSmallIotifA + Iso: UCS.SMALL.YA_IOTIF_AND_ISO,
    unicSmallIotifA + Apostrof: UCS.SMALL.YA_IOTIF_AND_APOSTROF,
    unicSmallKsi + Titlo: UCS.SMALL.KSI_AND_TITLO,
