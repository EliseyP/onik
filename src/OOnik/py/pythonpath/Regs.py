...
regs_acutes = (
    ...
    [r'чи(?=ст(?!от|ейш|илищ|итель))', OX, 'i'],
    # чистота̀
...
regs_titles_set = (
    ...
    [r'(а)посто(?=л)', r'\1п' + titlo_s, 'i'],
    [r'(б)лагода(?=т)', r'\1лг' + titlo_d, 'i'],
    [r'(б)лагосло(?=в)', r'\1лг' + titlo_s, 'i'],
    [r'(б)ла(?=[гж])', r'\1л' + titlo, 'i'],
    [r'''
        \b
        (б)ог
        (?=
    ...
    [r'\b(б)оз(?=ѣ)', r'\1з' + titlo, 'i'],
    [r'(в)лады(?=[кчц])', r'\1л' + titlo_d, 'i'],
    [r'(в)оскре(?=с\w\b)', r'\1оскр' + titlo, 'i'],
    [r'(в)оскресе?(?=\w\B)', r'\1оскр' + titlo_s, 'i'],
    ...
    [r'(ѻ)те?ц', r'\1ц' + titlo, 'i'],  # @@@ вариат.
    [r'(ѻ)те?ч(?!ест|а(ѧн|йш))', r'\1ч' + titlo, 'i'],  # @@@ вариат.
    [r'(п)равед(?=е?н)', r'\1рв' + titlo_d, 'i'],
    [r'(п)реподо(?=б(е?н))', r'\1рп' + titlo_d, 'i'],
    [r'(п)ред(?=теч)', r'\1р' + titlo_d, 'i'],
    [r'(п)рис(?=нѡ\b)', r'\1р' + titlo_s, 'i'],
    [r'(п)ро(?=ро[кч])', r'\1р' + titlo_o, 'i'],
    [r'(р)ождес(?=тв)', r'\1ж' + titlo_s, 'i'],
    [r'(с)вѧ([тщ])', r'\1\2' + titlo, 'i'],
    [r'(с)ерде?(?=[цч])', r'\1р' + titlo_d, 'i'],
    # FIXME: смр҃ть (??? вариант см҃рть)
    [r'(с)ме(?=рт)', r'\1м' + titlo, 'i'],
    [r'(с)па(?=с)', r'\1п' + titlo, 'i'],
    ...
    [r'(с)ын(?=[аеєѣоѡꙋъ])', r'\1н' + titlo, 'i'],  # @@@ вариант.
    [r'(т)рои(?=[цч])', r'\1р' + titlo_o, 'i'],
    [r'(?<!нт[иі])(х)ріс(?=т)', r'\1р' + titlo_s, 'i'],
    [r'(ч)ело(?=вѣ[кч])', r'\1л' + titlo, 'i'],
    [r'(ч)ес(?=тн)', r'\1' + titlo_s, 'i'],
    [r'(ч)ис(?=т)', r'\1' + titlo_s, 'i'],
    [r'(ц)арс', r'\1р' + titlo_s, 'i'],
    [r'(ц)ар(?=\w)', r'\1р' + titlo, 'i'],
    [r'(ц)ер(?=к)', r'\1р' + titlo, 'i'],
)
