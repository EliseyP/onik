...
regs_letters_in_word = (
    ...
    [r'\bм' + latin_i + r'(?=р)', r'мі', 'i'],
    [r'\bми(?=р(с[кт]|ѧн))', r'мі', 'i'],
...
regs_acutes = (
    ...
    # зрѣ́ти ᲂу҆зрѣ́ти
    [r'\b(^[Оᲂ]у(мо)?|пр[иео]|воз|лице)?зрѣ(?=[лнтхш])', OX, 'i'],
    # зрю̀  призрѣ̀
    ...
    [r'ра(?=д(ост[еиінь]|ꙋй(сѧ|тес[ьѧ])))', OX, 'i'],
    [r'ра(?=звѣ)', OX, 'i'],
    ...
    [r'слꙋ(?=жит[еъ]|мъ|ши)', OX, 'i'],
    [r'слꙋжѧ(?=й)', OX, 'i'],

    [r'\bслꙋ(?=ша)', OX, 'i'],
    [r'\B(?<!вы)слꙋша(?=[ншюѧ])', OX, 'i'],
